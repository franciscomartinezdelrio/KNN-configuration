#----------------------------------------------------------------------------------
# This file contains the experimentation with the M4 yearly dataset
# In my computer this experimentation took about 1 hour and 14 minutes
#----------------------------------------------------------------------------------
...
save(mase, file = "results_M4_yearly.RData")
...
round(apply(mase, 2, median, na.rm = TRUE), 3) # median

# To make the statistical differences analysis
# library(scmamp)                              # devtools::install_github("b0rxa/scmamp") to install it
# load("results_M4_yearly.RData")              # to execute if the data is saved in a file
