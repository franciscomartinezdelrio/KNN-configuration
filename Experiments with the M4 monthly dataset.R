#----------------------------------------------------------------------------------
# This file contains the experimentation with the M4 monthly dataset
# In my computer this experimentation took about 9 hours and 50 minutes
#----------------------------------------------------------------------------------
...
save(mase, file = "results_M4_monthly.RData")
...
# load("results_M4_monthly.RData")             # to execute if the data is saved in a file
